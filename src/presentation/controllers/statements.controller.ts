...
export class StatementsController {
  ...
  @Get()
  @ApiOkResponse({ description: "List statements by card" })
  list(@ReqUser() user: any, @Query("creditCardId") creditCardId: string) {
    return this.service.listByCard(user.userId, creditCardId);
  }
